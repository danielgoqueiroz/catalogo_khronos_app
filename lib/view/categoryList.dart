...
var posts;
int count = 1;
final _logger = Logger('CategoryList');
...
class CategoryList extends StatefulWidget {
  ...
  @override
  State<CategoryList> createState() => new _DynamicList();
}

class _DynamicList extends State<CategoryList> {
  int page = 0;
  ...
  getCategories() async {
    cats = await wooCommerce.getProductCategories(hideEmpty: true, parent: 0);
    setState(() {});
    print(cats.toString());
  }
          ...
          slivers: <Widget>[
            SliverGrid(
              ...
              delegate:
                ...
                return InkWell(
                    onTap: (){
                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => ContentList(category: category)));
                    },
                    child: Column(
